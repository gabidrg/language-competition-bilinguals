@ECHO OFF
TITLE LanguageCompetitionBilinguals
...
CD LanguageCompetitionBilinguals

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./LanguageCompetitionBilinguals.rs
